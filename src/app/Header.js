...
const Header = () => {
  return (
    <header className="z-10 px-4 flex items-center fixed top-0 w-full justify-between border-b border-b-zinc-600 bg-zinc-800">
              ...
              <image>
                ...
                >
                  <g
                    ...
                    speechify-initial-font-size="12px"
                  >
                    <g speechify-initial-font-size="12px">
                      <path
                        fill-rule="nonzero"
      ...
      <nav className="flex flex-grow justify-end basis-0">
        <ul className="flex [&>li>a]:px-12">
          ...
          <li>
            <a href="/">
              <img className="w-8 h-8 rounded-full" src="/img/Heber.jpg"></img>
            </a>
          </li>
        </ul>
      </nav>
